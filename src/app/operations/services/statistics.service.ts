...
export class StatisticsService {
  ...
  setNotification(notificationCards1:any[]){
    this.notificationCards = [];
    console.log(notificationCards1);
    console.log(this.notificationCards)
    ...
    let chartCardsArr = [
      {
        ...
        chardData: {
          datasets: [
            {
              label: 'Weekly',
              data: [statisicsObj.weeklyObj.acceptedRequests, statisicsObj.weeklyObj.underReviewRequests, statisicsObj.weeklyObj.rejectedRequests],
      ...
      },
      {
        ...
        chardData: {
          datasets: [
            {
              label: 'Monthly',
              data: [statisicsObj.monthlyObj.acceptedRequests, statisicsObj.monthlyObj.underReviewRequests, statisicsObj.monthlyObj.rejectedRequests],
              backgroundColor: ['#0070C4', '#DFB50B', '#FF0000'],
              hoverOffset: 4,
            },
          ],
