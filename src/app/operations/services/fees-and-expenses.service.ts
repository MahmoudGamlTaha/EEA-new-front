...
import { RequestSubmittedService } from './request-submitted.service';
...
setCustomerRequest(request){
  ...
  InitTotalAndReviewForm(requestFees, customerRequest, Iscustomer){
    ...
    if(!Iscustomer){
    this.statusArr = [
      { name: 'customer.approval',value: "AcceptProtectEEA",class:'col-md-6 col-12' },
      { name: 'customer.rejection',value: "Rejected",class:'col-md-6 col-12' },
    ];
    this.reviewersList = [
      {
        name: 'مصطفي محمد 1',
  ...
  initForm(requestFees, customerRequest, Iscustomer) {
    ...
    return this.feesForm = {
      ...
      administrativeFees: {
        ...
        isDisabled:true,
        col: 'col-12 pb-3',
        label: 'customer.administrativeFees',
      //  labelStyle: 'boldFormLabel fs-5',
        subModel: {
          ...
          pricePerTon: {
            ...
            isDisable:Iscustomer && customerRequest.status =='AcceptProtectEEA',
            col: this.currentLang === 'ar' ? 'col-12 mb-3 ps-0' : 'col-12 pe-0',
