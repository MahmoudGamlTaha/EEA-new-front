...
@Component({
  ...
  standalone: true,
  imports: [CommonModule , SharedModule , SubtitleComponent , DynamicFormComponent , RdfFormComponent , ReviewerFormComponent],
...
export class WasteManagementAdmissionFormComponent {
  ...
  constructor(private wasteManagementAdmissionFormService : WasteManagementAdmissionFormService){
