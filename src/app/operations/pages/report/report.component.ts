...
@Component({
  selector: 'app-report',
  standalone: true,
  imports: [CommonModule,SubtitleComponent , TranslateModule ,FilterComponent , SearchComponent , DynamicTableComponent, DynamicPieChartComponent],
  templateUrl: './report.component.html',
  styleUrl: './report.component.scss'
})
export class ReportComponent {
  @ViewChild('dynamicTableWrapper', { static: false })  dynamicTableWrapper: DynamicTableComponent;
  @ViewChild('reportsData', { static: false })  reportsData: DynamicTableComponent;
  headers;
  tableData: string[];
  reportHeaders;
  ...
  constructor(private requestSubmittedService: RequestSubmittedService , private tableService: TableService, private reportService: ReportsService) {
  ...
  ngAfterViewInit() {
    ...
    const reportTableHeaders = this.tableService.initTableHeaders(this.reportHeaders)
