...
const routes: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: 'statistics', pathMatch: 'full' },
      {
        path: 'statistics',
        loadChildren: () =>
          import('@operations/pages/statistics-container/statistics.module').then((m) => m.StatisticsModule),
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '@operations/pages/company-info/company-info.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '@shared/pages/order-tracking/order-tracking.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '@operations/pages/endorsement/endorsement.component'
          ).then((m) => m.EndorsementComponent),
      ...
      },
      {
        path: 'approval',
        loadComponent: () =>
          import('@operations/pages/approval-form-wrapper/approval-form-wrapper.component').then(
            (m) => m.ApprovalFormWrapperComponent
          ),
      ...
      },
      {
        path: 'paymentSuccess',
        loadComponent: () =>
          import('@operations/pages/payment-success/payment-success.component').then(
