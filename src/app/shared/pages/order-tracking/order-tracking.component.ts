...
export class OrderTrackingComponent {
  ...
  getOrderTrackingByRequestId(id){
    this.orderTrackingService.getOrderTrackingByRequestId(id).subscribe(
      res=> this.orderTrackingList = this.orderTrackingService.initOrderTrackingList(res['content'] , this.isRequestRdf)
    )
  }
